...
export const UNITS: Unit[] = [
  ...
  { id: 5, slug: "wohnen", title: "Wohnen", subtitle: "Home, rooms & furniture", type: "vocab", level: "A1.2", xp: 60, estimatedMinutes: 15 },
  { id: 6, slug: "alltagsverben", title: "Alltagsverben", subtitle: "Regular verbs, present tense", type: "grammar", level: "A1.2", xp: 60, estimatedMinutes: 20 },
  ...
  { id: 9, slug: "essen-trinken", title: "Essen & Trinken", subtitle: "Food, ordering & shopping", type: "vocab", level: "A1.3", xp: 70, estimatedMinutes: 15 },
  { id: 10, slug: "modal-verben", title: "Modal Verben", subtitle: "können, müssen, wollen", type: "grammar", level: "A1.3", xp: 70, estimatedMinutes: 20 },
  { id: 11, slug: "in-der-stadt", title: "In der Stadt", subtitle: "Directions, transport & places", type: "vocab", level: "A1.3", xp: 70, estimatedMinutes: 15 },
  { id: 12, slug: "a1-review", title: "A1 Review", subtitle: "Full skill sweep", type: "review", level: "A1.3", xp: 100, estimatedMinutes: 30 },
];

export function getStartUnit(level: "A1.1" | "A1.2" | "A1.3"): number {
  if (level === "A1.1") return 1;
  if (level === "A1.2") return 5;
  return 9;
}
